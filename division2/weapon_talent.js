...
(function () {
  ...
  async function loadWeaponTalentRows() {
    return window.loadItemsView("weapon_talent", indexJson?.built_at);
  }
  ...
  function renderWeaponTalentViewFromRows(payload) {
    ...
    rows.forEach((r, idx) => {
      ...
      // normalize_jp is already the translated PvP text; resolving by talent
      // key would replace it with the PvE translation.
